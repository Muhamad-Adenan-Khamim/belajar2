...
<html class="no-js">
	...
	<title>Welcome To Vlog Food</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="" />
	<meta name="keywords" content="" />
	<meta name="author" content="M Fajar Atorik (161080200109)" />
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Start Your Business With This Vlog Food</h2>
		   					<p><a href="https://api.whatsapp.com/send?phone= 088217286918&text= halo%20admin%20saya%20mau%20tanya?" class="btn btn-primary btn-lg">Chat kami</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
	...
	<div class="fh5co-section-with-image">
		...
		<div class="fh5co-box animate-box">
			<h2>Berpikir Maju</h2>
			<p>Kami Selalu Memberikan Menu-Menu Terbaik.</p>
