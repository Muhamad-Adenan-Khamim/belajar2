			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>jabon 2</li>
						<li><i class="icon-phone"></i>081238163018</li>
						<li><i class="icon-envelope"></i><a href="#">Vlog@Food.com</a></li>
						<li><i class="icon-globe"></i><a href="#">www.VlogFood.com</a></li>
					</ul>
				</div>
