...
<html class="no-js">
	...
	<meta name="author" content="M.FAJAR ATORIK (109)" />
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					...
		   					<p class="fh5co-lead"> Awesome source code by <a href="http://mfajar.com/" target="_blank">M.FAJAR ATORIK (109)</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
